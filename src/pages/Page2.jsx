...
const Page2 = () => {
  ...
  return (
    <BackgroundContainer bgImage="/bg_page_teams.png" titleImage="/title_farewell.png">
              ...
              <div className="mb-8">
                ...
                <div className="space-y-2">
                  {options.map((option) => (
                    <div
                      key={option}
                      className={`flex items-center justify-center p-4 border-2 rounded cursor-pointer ${
                        state.page2 === option
                          ? "border-green-500"
                          : "border-transparent"
